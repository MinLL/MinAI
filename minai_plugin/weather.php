...
function GetWeatherContext() {
    $weathers = [
        ...
        "0010e1f2" => ["name" => "SkyrimClear", "description" => "A	Near cloudless, blue sky."],
        "0010e1f1" => ["name" => "SkyrimCloudy", "description" => "A	Cloudy sky."],
        "0010e1f0" => ["name" => "SkyrimClearSN", "description" => "A	Near cloudless, blue sky."],
        "0010e1ef" => ["name" => "SkyrimCloudySN", "description" => "A	Cloudy sky."],
        "0010e1ee" => ["name" => "SkyrimClearTU", "description" => "A	Near cloudless, blue sky."],
        "0010e1ed" => ["name" => "SkyrimCloudyTU", "description" => "A	Cloudy sky."],
        "0010e1ec" => ["name" => "SkyrimClearFF", "description" => "A	Near cloudless, blue sky."],
        "0010e1eb" => ["name" => "SkyrimCloudyFF", "description" => "A	Cloudy sky."],
        "0010e1ea" => ["name" => "SkyrimClearRE", "description" => "A	Cloudy sky."],
        "0010e1e9" => ["name" => "SkyrimCloudyRE", "description" => "A	Cloudy sky."],
        "0010e1e8" => ["name" => "SkyrimClearCO", "description" => "A	Cloudy sky."],
        "0010e1e7" => ["name" => "SkyrimCloudyCO", "description" => "A	Dark cloudy sky."],
        "0010e1e6" => ["name" => "SkyrimClearMA", "description" => "A	Cloudy sky."],
        "0010e1e5" => ["name" => "SkyrimCloudyMA", "description" => "A	Dark cloudy sky."],
        "0010e1e4" => ["name" => "SkyrimClearVT", "description" => "A	Cloudy sky."],
        "0010e1e3" => ["name" => "SkyrimCloudyVT", "description" => "A	Cloudy sky."],
        ...
        "02010E0F" => ["name" => "DLC1", "description" => "SkyrimClearFV	Near cloudless, blue sky."],
        "02010E10" => ["name" => "DLC1", "description" => "SkyrimClearFV_A	Near cloudless, blue sky."],
        "02010E0E" => ["name" => "DLC1", "description" => "SkyrimCloudyFV	Cloudy sky."],
        "02010E0B" => ["name" => "DLC1", "description" => "SkyrimCloudyFV_A	Cloudy sky."],
        "0200F89C" => ["name" => "DLC1AurielsBowClearWeather", "description" => "Near cloudless, blue sky."],
        "02006AEC" => ["name" => "DLC1Eclipse", "description" => ""],
        "02019599" => ["name" => "DLC1FalmerValley", "description" => "bf	Cloudy sky."],
        "020195A0" => ["name" => "DLC1FalmerValley", "description" => "bfDark	Cloudy sky."],
        ...
        "040374B8" => ["name" => "DLC02VolcanicAsh01", "description" => "A	Cloudy sky with ash particles."],
        "04031AC0" => ["name" => "DLC02VolcanicAsh02", "description" => "Cloudy sky with ash particles."],
        "040374B9" => ["name" => "DLC02VolcanicAsh02", "description" => "A	Near cloudless sky with ash particles."],
        ...
        "040374BA" => ["name" => "DLC02VolcanicAshTundra01", "description" => "A	Cloudy sky with ash particles."],
