...
function GetLocationDetails($locationName) {
	...
	if (strlen($s_loc) > 3) {
		...
		"mzulft"				=> "a Dwarven ruin south-southeast of Windhelm containing Dwarven automatons, Falmer, and chaurus. <oculory_puzzle_solution>Oculory puzzle solution: insert a Focusing Crystal and then use fire and ice  spells to direct the light beams onto the lenses in the correct order</oculory_puzzle_solution>", 
