# MinAI
A significant expansion to AIFF that brings AI to the entirety of the Skyrim world, and bridges LLMs with various Skyrim Mods. 
...
* Mantella and AIFF are both supported. However, this mod's capabilities are much, much more advanced for AIFF than Mantella. Mantella's feature-set is effectively frozen, and new development is focused around AIFF.

## AI Follower Framework Extensions
...
* After installing the plugin, run the AIFF Server Update file that came with DwemerDistro.
