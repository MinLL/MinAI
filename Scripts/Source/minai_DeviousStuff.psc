...
function Maintenance(minai_MainQuestController _main)
  ...
  if Game.GetModByName("DeviouslyAccessible.esp") != 255
    ...
    if (!dwp_global_minai)
      ...
      Main.Notification("Old version of Deviously Accessible. Some integrations will be broken.")
    EndIf
  EndIf  
  ...
  aiff.RegisterAction("ExtCmdTeaseWithVibratorVeryWeak", "TeaseWithVibratorVeryWeak", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdStimulateWithVibratorVeryWeak", "StimulateWithVibratorVeryWeak", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdTeaseWithVibratorWeak", "TeaseWithVibratorWeak", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdStimulateWithVibratorWeak", "StimulateWithVibratorWeak", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdTeaseWithVibratorMedium", "TeaseWithVibratorMedium", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdStimulateWithVibratorMedium", "StimulateWithVibratorMedium", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdTeaseWithVibratorStrong", "TeaseWithVibratorStrong", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdStimulateWithVibratorStrong", "StimulateWithVibratorStrong", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdTeaseWithVibratorVeryStrong", "TeaseWithVibratorVeryStrong", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
  aiff.RegisterAction("ExtCmdStimulateWithVibratorVeryStrong", "StimulateWithVibratorVeryStrong", "", "Devious Stuff", 1, 5, 2, 5, 300, bHasDD)
