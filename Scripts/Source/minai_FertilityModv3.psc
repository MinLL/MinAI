...
Function Maintenance(minai_MainQuestController _main)
    ...
    if Game.GetModByName("Fertility Mode 3 Fixes and Updates.esp") != 255
        FertilityModV3_PMS = Game.GetFormFromFile(0x00081B, )
        FertilityModV3_Fertile = Game.GetFormFromFile(0x00081B)
        FertilityModV3_FirstTrimester = Game.GetFormFromFile(0x00081B)
        FertilityModV3_SecondTrimester = Game.GetFormFromFile(0x00081B)
        FertilityModV3_ThirdTrimester = Game.GetFormFromFile(0x00081B)
        FertilityModV3_Labor = Game.GetFormFromFile(0x000CEC)
        bHasFertilityMode3FixesAndUpdates = True
        bHasFertilityModV3 = True
    ElseIf Game.GetModByName("Fertility Mode.esm") != 255
        FertilityModV3_PMS = Game.GetFormFromFile(0x017718, )
        FertilityModV3_Fertile = Game.GetFormFromFile(0x0181E2)
        FertilityModV3_FirstTrimester = Game.GetFormFromFile(0x01B816)
        FertilityModV3_SecondTrimester = Game.GetFormFromFile(0x01B818)
        FertilityModV3_ThirdTrimester = Game.GetFormFromFile(0x01B81A)
        bHasFertilityModV3 = True
    EndIf
...
Function SetContext(actor akActor)
    ...
    string whoKnows = GetStringForEverybodyVSActor()
...
string Function GetStringForActor()
